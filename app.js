...
//          it refers to the prototype function
// 2. What is "this" when joe.scopeArrow() is invoked?
//            this refers to the window
// 3. Explain why "this" is different when an arrow function is used.
//    arrow functions refer to the parent of the fuction, in the case of an arrow function that does not have a parent, the default will be the window
